...
void __initLinks()
{
	...
	//Route configuration
	write_sswitch_reg_no_ack_clean(myid,0x0c,0x00000010);
	write_sswitch_reg_no_ack_clean(myid,0x0d,0x00000000);
	//Attach links to routes
	write_sswitch_reg_no_ack_clean(myid,0x22,0x00000500);
	write_sswitch_reg_no_ack_clean(myid,0x23,0x00000100);
	write_sswitch_reg_no_ack_clean(myid,0x24,0x00000000);
	write_sswitch_reg_no_ack_clean(myid,0x25,0x00000000);
	write_sswitch_reg_no_ack_clean(myid,0x26,0x00000000);
	write_sswitch_reg_no_ack_clean(myid,0x27,0x00000000);
